...
/* subscribe.c */
extern void init_ipmi_subscribe(void);
...
/* app_intf.c */
extern void ipmi_init(void);
extern void deliver_app_msg_to_user(struct app_msg_hdr *msg, unsigned short port, ipmi_json_ipc_header_t header);


/* ipmb_intf.c */
extern void register_ipmb_resp(void);
extern void ipmb_send_outbound_msg(unsigned char *msg, int len);


/* ipmb_handler.c */
extern void init_ipmb_msg_handler(void);
extern void handle_ipmb_msg(unsigned char *msg, int len);
extern void deliver_ipmi_msg_by_ipmb(struct appmsg_ipmi_msg *msg);


/* rmcp_intf.c */
extern void register_rmcp_resp(void);
...
extern void app_json_rpc_msg(int fd, char *dest_msg);
extern void app_json_parse(struct app_recv_msg *list, char *dest_msg);
#endif

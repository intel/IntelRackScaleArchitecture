...
pzones=     ['http://remoteip/v1/rack/powerzones/rf_event',                               g_rfEvents,  'http://subcribe_ip/v1/rack/psu' ]
pzone=      ['http://remoteip/v1/rack/powerzones/{pzone_id}/rf_event',                    g_rfEvents,  'http://subcribe_ip/v1/rack/psu' ]
psu =       ['http://remoteip/v1/rack/powerzones/{pzone_id}/psus/{psu_id}/rf_event',      g_rfEvents,  'http://subcribe_ip/v1/rack/psu' ]
psus =      ['http://remoteip/v1/rack/powerzones/{pzone_id}/psus/rf_event',               g_rfEvents,  'http://subcribe_ip/v1/rack/psu' ]
fzones =    ['http://remoteip/v1/rack/thermalzones/rf_event',                             g_rfEvents,  'http://subcribe_ip/v1/rack/fan' ]
fzone=      ['http://remoteip/v1/rack/thermalzones/{tzone_id}/rf_event',                  g_rfEvents,  'http://subcribe_ip/v1/rack/fan' ]
fan =       ['http://remoteip/v1/rack/thermalzones/{tzone_id}/fans/{fan_id}/rf_event',    g_rfEvents, 'http://subcribe_ip/v1/rack/fan' ]
fans =      ['http://remoteip/v1/rack/thermalzones/{tzone_id}/fans/rf_event',             g_rfEvents, 'http://subcribe_ip/v1/rack/fan' ]
rsyses =     ['http://remoteip/v1/rack/drawers/rf_event',                                 g_rfEvents, 'http://subcribe_ip/v1/rack/drawer' ]
rsys=        ['http://remoteip/v1/rack/drawers/{sys_id}/rf_event',                        g_rfEvents,  'http://subcribe_ip/v1/rack/drawer' ]
mbpes =     ['http://remoteip/v1/rack/mbps/rf_event',                                     g_rfEvents,  'http://subcribe_ip/v1/rack/mbp' ]
mbp=        ['http://remoteip/v1/rack/mbps/{mbp_id}/rf_event',                            g_rfEvents,  'http://subcribe_ip/v1/rack/mbp' ]
rack=       ['http://remoteip/v1/rack/rf_event',                                          g_rfEvents,  'http://subcribe_ip/v1/rack/rack']
...
if __name__ == "__main__":
    ...
    localip = sys.argv[2]
    changeDefData(localip, remoteip)
    run()

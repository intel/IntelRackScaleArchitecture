...
extern void libipmi_ipmb_cmd(unsigned char sa, struct ipmi_msg *req,
			ipmi_rsp_callback_fn cb_fn, void *cb_arg);
extern void libipmi_ipmb_cmd_timeout(unsigned char sa, struct ipmi_msg *req,
			ipmi_rsp_callback_fn cb_fn, void *cb_arg, unsigned int timeo);
extern void libipmi_ipmb_cmd_broadcast(struct ipmi_msg *req,
			ipmi_rsp_callback_fn cb_fn, void *cb_arg);
...
extern void jrpc_libipmi_ipmb_cmd(unsigned char sa, struct ipmi_msg *req,

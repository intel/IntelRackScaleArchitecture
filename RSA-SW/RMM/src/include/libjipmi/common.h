...
/* timeout in ms */
#define IPMI_PERIOD_TIME_MS      1000 /* call every ~1000 ms to check timeout */
#define IPMI_DFLT_TIMEOUT_MS     10000
#define IPMI_MAX_TIMEOUT_MS      30000 /* Don't let a message sit in a queue forever. */

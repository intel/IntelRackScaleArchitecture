...
package com.intel.rsa.common.types.iscsi;
...
public class IscsiSanUriTest {
    ...
    public void testParsingValidUri(String uri, String targetName, String server, int port, int lun) throws Exception {
        ...
        Assert.assertEquals(sut.getTargetName(), targetName);
        Assert.assertEquals(sut.getServerName(), server);
        Assert.assertEquals(sut.getPort(), port);
        Assert.assertEquals(sut.getLun(), lun);
    }
    ...
    public void testToString(String uri, String toStringValue) throws Exception {
        ...
        Assert.assertEquals(sut.toString(), toStringValue);
    }

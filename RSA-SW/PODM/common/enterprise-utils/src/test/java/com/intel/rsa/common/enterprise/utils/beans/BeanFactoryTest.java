 ...
 */
package com.intel.rsa.common.enterprise.utils.beans;
...
public class BeanFactoryTest {
    ...
    public void whenCreatingNewInstance_ShouldReturnObjectedInstantiatedByBeanManager() {
        ...
        // we are not sure what should be passed here
        // todo make sure that it is ok
    ...
    public void whenCreatingNewInstance_ShouldCreateBeanWithCorrectContext() {
        ...
        // we are not sure what should be passed here,
        // but it seems to work with context created with bean.
        // TODO It should be clarified

...
public final class RssReaderImpl implements RssReader {
    ...
    public RssReaderImpl(WebClient webClient) {
        this.webClient = webClient;
    }

    @Override
    public RssServiceRoot getServiceRoot() throws RsaApiReaderException {
        RssServiceRootImpl serviceRoot = webClient.getBase(RssServiceRootImpl.class);
        serviceRoot.setWebClient(webClient);
        return serviceRoot;
    }

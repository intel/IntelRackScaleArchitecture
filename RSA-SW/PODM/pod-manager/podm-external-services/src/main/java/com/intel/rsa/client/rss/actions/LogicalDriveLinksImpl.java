...
public class LogicalDriveLinksImpl implements LogicalDriveLinks {

    private List<ODataIdWrapper> wrappers = new ArrayList<>();

    @Override
    @JsonProperty("LogicalDrives")
    public List<ODataIdWrapper> getODataIdWrappers() {
        return wrappers;
    }
}

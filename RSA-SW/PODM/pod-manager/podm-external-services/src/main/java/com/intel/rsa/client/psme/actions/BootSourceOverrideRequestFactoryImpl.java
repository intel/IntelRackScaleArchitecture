...
public class BootSourceOverrideRequestFactoryImpl implements BootSourceOverrideRequestFactory {
    public BootSourceOverrideRequest create(BootSourceType bootSourceType, BootSourceState bootSourceState) {
        return new BootSourceOverrideRequestImpl(bootSourceType, bootSourceState);
    }

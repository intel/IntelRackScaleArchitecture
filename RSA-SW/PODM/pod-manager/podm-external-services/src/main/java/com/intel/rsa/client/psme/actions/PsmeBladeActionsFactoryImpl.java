...
public class PsmeBladeActionsFactoryImpl implements PsmeBladeActionsFactory {
    @Override
    public PsmeBladeActions create(URI baseUri) {
        return new PsmeBladeActionsImpl(baseUri);
    }
}

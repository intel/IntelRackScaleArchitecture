...
public class ResetRequestFactoryImpl implements ResetRequestFactory {

    @Override
    public ResetRequest create(ResetType resetType) {
        return new ResetRequestImpl(resetType);
    }
}

...
package com.intel.rsa.podm.repositories.orientdb.graph;
...
public class GraphConnectionProducer {
    ...
    public void closeTransactional(@Disposes @PodGraph(transactional = true) OrientDatabaseConnection conn) {
        conn.close();
    }

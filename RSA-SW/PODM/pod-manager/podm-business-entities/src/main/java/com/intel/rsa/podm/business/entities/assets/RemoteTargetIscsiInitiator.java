...
public class RemoteTargetIscsiInitiator extends DomainObject {

    public static final DomainObjectProperty<String> INITIATOR_IQN = stringProperty("initiatorIqn");

    public String getInitiatorIqn() {
        return getProperty(INITIATOR_IQN);
    }

    public void setInitiatorIqn(String initiatorIqn) {
        setProperty(INITIATOR_IQN, initiatorIqn);
    }
}

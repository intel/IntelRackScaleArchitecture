...
public class Drive extends Asset {
    ...
    public StorageController getStorageController() {
        try {
            return single(getLinked(AssetLink.CONTAINED_BY, StorageController.class));
        } catch (IllegalStateException e) {
            throw new IllegalStateException("Drive has to be contained by exactly one StorageController", e);
        }
    }

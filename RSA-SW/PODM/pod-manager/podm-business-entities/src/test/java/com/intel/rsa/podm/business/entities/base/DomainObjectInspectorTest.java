...
public class DomainObjectInspectorTest {
    ...
    @Test
    public void whenInspectingClassWithoutPropertiesShouldReturnEmptyMapOfProperties() {
            ...
            Assert.assertEquals(properties, emptyMap());
        }
    ...
    public void whenInspectingClassWithSinglePropertyShouldReturnValidMapOfProperties() {
        ...
        Assert.assertEquals(properties, ImmutableMap.of("name", String.class));
    }
    ...
    public void whenInspectingClassWithTwoPropertiesShouldReturnValidMapOfProperties() {
        ...
        Assert.assertEquals(properties, ImmutableMap.of(
                "size", Integer.class,

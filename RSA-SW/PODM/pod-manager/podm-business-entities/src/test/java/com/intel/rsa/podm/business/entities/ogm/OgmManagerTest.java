...
import com.intel.rsa.podm.business.entities.base.ClassWithOneProperty;
import com.intel.rsa.podm.business.entities.base.ClassWithThreeProperties;
import com.intel.rsa.podm.business.entities.base.ClassWithTwoProperties;
import com.intel.rsa.podm.business.entities.base.ClassWithoutProperties;
...
public class OgmManagerTest {
    ...
    public void whenAddingToMapping_ShouldCreateProperVertexType() {
        ...
        GraphVertexType vertexType = new GraphVertexType("ClassWithoutProperties", Collections.emptyMap());
    ...
    public void whenAddingMultipleDomainObjectsToMapping_ShouldCreateProperVertexTypes() {
        ...
        GraphVertexType firstVertexType = new GraphVertexType("ClassWithOneProperty", ImmutableMap.of("name", String.class));
        verify(sut.graphSchemaManager).registerVertexType(firstVertexType);

        GraphVertexType secondVertexType = new GraphVertexType("ClassWithoutProperties", Collections.emptyMap());

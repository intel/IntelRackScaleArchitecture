...
@Dependent
public class StorageControllerMapper extends DomainObjectMapper<PsmeStorageController, StorageController> {

    public StorageControllerMapper() {
        super(PsmeStorageController.class, StorageController.class);
    }

    @Override
    protected void performNotAutomatedMapping(PsmeStorageController source, StorageController target) {

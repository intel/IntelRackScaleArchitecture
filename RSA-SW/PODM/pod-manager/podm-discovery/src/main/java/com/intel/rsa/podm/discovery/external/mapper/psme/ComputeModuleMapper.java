...
@Dependent
public class ComputeModuleMapper extends DomainObjectMapper<PsmeComputeModule, ComputeModule> {

    public ComputeModuleMapper() {
        super(PsmeComputeModule.class, ComputeModule.class);
    }

    @Override
    protected void performNotAutomatedMapping(PsmeComputeModule source, ComputeModule target) {

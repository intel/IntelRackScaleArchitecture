...
@Dependent
public class PhysicalDriveMapper extends DomainObjectMapper<RssDrive, PhysicalDrive> {
    public PhysicalDriveMapper() {
        super(RssDrive.class, PhysicalDrive.class);
    }

    @Override
    protected void performNotAutomatedMapping(RssDrive source, PhysicalDrive target) {

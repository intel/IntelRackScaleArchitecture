...
@Dependent
public class MemoryMapper extends DomainObjectMapper<PsmeMemory, Memory> {
    protected MemoryMapper() {
        super(PsmeMemory.class, Memory.class);
        useLooseMatchingStrategy();
    }

    @Override
    protected void performNotAutomatedMapping(PsmeMemory source, Memory target) {

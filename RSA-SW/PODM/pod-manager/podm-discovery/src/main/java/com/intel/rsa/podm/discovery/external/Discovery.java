...
import com.intel.rsa.podm.discovery.external.restgraph.RestGraphBuilder;
...
public class Discovery {
    ...
    @Inject
    private DomainObjectGraphMapper mapper;

    public void discover(RsaReader client) {
        RestGraph graph = restGraphBuilder.build(client);

...
@Dependent
public class LogicalDriveMapper extends DomainObjectMapper<RssLogicalDrive, LogicalDrive> {
    public LogicalDriveMapper() {
        super(RssLogicalDrive.class, LogicalDrive.class);
        skipTargetMapping(LogicalDrive.class);
    }

    @Override
    protected void performNotAutomatedMapping(RssLogicalDrive source, LogicalDrive target) {

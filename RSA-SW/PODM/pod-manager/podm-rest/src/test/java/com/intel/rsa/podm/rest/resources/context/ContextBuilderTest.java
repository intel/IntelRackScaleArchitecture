...
public class ContextBuilderTest {
    ...
    public Object[][] correctPathParamsForContextBuilding() {
        return new Object[][] {
                {
                        newArrayList(param("podId", id(1))),
                        contextOf(id(1), POD)
                },
                {
                        newArrayList(param("podId", id(1)), param("rackId", id(2))),
                        contextOf(id(1), POD).child(id(2), RACK)
                },
                {
                        newArrayList(param("podId", id(2)), param("rackId", id(3))),
                ...
                },
                {
                        newArrayList(
                                ...
                                param("rackId", id(3)),
                                param("drawerId", id(4)),
                                param("computeModuleId", id(5))
                        ),
                        contextOf(id(2), POD).child(id(3), RACK).child(id(4), DRAWER).child(id(5), COMPUTE_MODULE)
                }
        };
    }

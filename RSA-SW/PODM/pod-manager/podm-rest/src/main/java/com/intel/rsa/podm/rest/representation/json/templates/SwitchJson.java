...
@JsonPropertyOrder({
        ...
        "status",
        "location", "oem", "links", "actions"
})
public final class SwitchJson extends BaseJson {
    public Id id;
    public String name;
    ...
    public final Object actions = new Object();

    public SwitchJson() {
        super("#RSASwitch.1.0.0.RSASwitch");
    }

    public static final class Links extends BaseLinksJson {
        public ODataId switchPorts;

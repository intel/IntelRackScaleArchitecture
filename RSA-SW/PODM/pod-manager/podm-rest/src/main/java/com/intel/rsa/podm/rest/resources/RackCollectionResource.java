...
public class RackCollectionResource extends BaseResource {
    ...
    public CollectionDto get() {
        ...
        try {
            return service.getRackCollection(context);
    ...
    @Path("{rackId}")
    public RackResource getRack() {
        return getResource(RackResource.class);
    }
}

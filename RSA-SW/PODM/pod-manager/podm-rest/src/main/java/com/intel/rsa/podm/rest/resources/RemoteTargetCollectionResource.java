...
import com.intel.rsa.podm.business.services.RemoteTargetService;
...
public class RemoteTargetCollectionResource extends BaseResource {

    @Inject
    private RemoteTargetService service;

    @Override
    public CollectionDto get() {
        Context context = getCurrentContext();
        try {
            return service.getRemoteTargetCollection(context);
    ...
    @Path("{remoteTargetId}")
    public RemoteTargetResource getStorageService() {

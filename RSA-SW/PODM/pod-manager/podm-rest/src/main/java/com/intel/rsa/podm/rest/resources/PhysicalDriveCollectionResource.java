...
import com.intel.rsa.podm.business.services.PhysicalDriveService;
...
public class PhysicalDriveCollectionResource extends BaseResource {
    ...
    public CollectionDto get() {
        ...
        try {
            return service.getPhysicalDriveCollection(context);
        } catch (EntityNotFoundException e) {
            throw PodmExceptions.notFound();
        }
    }

    @Path("{physicalDriveId}")
    public PhysicalDriveResource getDrive() {

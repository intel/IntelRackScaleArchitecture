...
import com.intel.rsa.podm.rest.representation.json.serializers.DtoSerializerContext;
...
public class JsonProvider extends JacksonJsonProvider {
    ...
    public void initialize(Instance<ContextAwareSerializer> serializers) {
        RsaObjectMapperModuleProvider mapperModuleProvider = new RsaObjectMapperModuleProvider();

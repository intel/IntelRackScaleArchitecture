...
public final class DrawerJson extends BaseJson {
    public Id id;
    public String name;
    public LocationJson location;
    public final String chassisType = "Shelf";
    ...
    public DrawerJson() {
        super("#RSADrawer.1.0.0.RSADrawer");
    }

    @JsonPropertyOrder({"computeModules", "fabricModules", "managedBy", "oem"})
    public static final class Links extends BaseLinksJson {
        public ODataId fabricModules;
        public ODataId computeModules;

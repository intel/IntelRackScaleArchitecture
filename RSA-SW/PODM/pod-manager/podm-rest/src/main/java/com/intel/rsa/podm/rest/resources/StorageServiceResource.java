...
import com.intel.rsa.podm.business.services.StorageServiceService;
...
import static com.intel.rsa.podm.rest.resources.ResourceNames.LOGICAL_DRIVES_RESOURCE_NAME;
import static com.intel.rsa.podm.rest.resources.ResourceNames.PHYSICAL_DRIVES_RESOURCE_NAME;
...
public class StorageServiceResource extends BaseResource {
    ...
    @Inject
    private StorageServiceService service;

    @Override
    public Object get() {
        try {
            Context context = getCurrentContext();
            return service.getStorageService(context);
        } catch (EntityNotFoundException e) {
            throw PodmExceptions.notFound();
        }
    }

    @Path("{storageServiceId}")
    ...
    public PhysicalDriveCollectionResource getPhysicalDrives() {
        return getResource(PhysicalDriveCollectionResource.class);
    }

    @Path(LOGICAL_DRIVES_RESOURCE_NAME)
    public LogicalDriveCollectionResource getLogicalDrives() {
        return getResource(LogicalDriveCollectionResource.class);
    }

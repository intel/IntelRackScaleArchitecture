...
import com.intel.rsa.podm.business.services.StorageManagerService;
...
public class StorageManagerResource extends BaseResource {

    @Inject
    private StorageManagerService service;

    @Override
    public StorageManagerDto get() {
        try {
            Context context = getCurrentContext();
            return service.getStorageManager(context);

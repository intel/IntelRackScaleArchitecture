...
public class LogicalDriveCollectionResource extends BaseResource {
    @Inject
    ...
    public CollectionDto get() {
        ...
        try {
            return service.getLogicalDriveCollection(context);
    ...
    @Path("{logicalDriveId}")
    public LogicalDriveResource getDrive() {
        return getResource(LogicalDriveResource.class);
    }
}

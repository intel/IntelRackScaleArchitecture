...
public class FabricModuleCollectionResource extends BaseResource {
    @Inject
    ...
    public CollectionDto get() {
        ...
        try {
            return service.getFabricModuleCollection(context);
    ...
    @Path("{fabricModuleId}")
    public FabricModuleResource getFabricModule() {
        return getResource(FabricModuleResource.class);
    }
}

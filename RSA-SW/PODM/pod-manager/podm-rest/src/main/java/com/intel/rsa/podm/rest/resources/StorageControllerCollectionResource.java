...
public class StorageControllerCollectionResource extends BaseResource {
    ...
    public CollectionDto get() {
        ...
        try {
            return service.getStorageControllerCollection(context);
        } catch (EntityNotFoundException e) {
            throw PodmExceptions.notFound();
        }
    }

    @Path("{storageControllerId}")
    public StorageControllerResource getStorageController() {
        return getResource(StorageControllerResource.class);
    }
}

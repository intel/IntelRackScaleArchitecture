...
public class ComputeModuleCollectionResource extends BaseResource {
    ...
    public CollectionDto get() {
        ...
        try {
            return service.getComputeModuleCollection(context);
        } catch (EntityNotFoundException e) {
            throw PodmExceptions.notFound();
        }
    }

    @Path("{computeModuleId}")
    public ComputeModuleResource getComputeModule() {
        return getResource(ComputeModuleResource.class);
    }
}

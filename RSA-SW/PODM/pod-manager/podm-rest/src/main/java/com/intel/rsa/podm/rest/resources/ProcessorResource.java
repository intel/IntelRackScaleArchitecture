...
import com.intel.rsa.podm.business.services.ProcessorService;
...
public class ProcessorResource extends BaseResource {

    @Inject
    private ProcessorService service;

    @Override
    public ProcessorDto get() {
        Context context = getCurrentContext();
        try {
            return service.getProcessor(context);

...
import com.intel.rsa.podm.business.services.VlanNetworkInterfaceService;
...
public class VlanNetworkInterfaceResource extends BaseResource {
    ...
    @Inject
    private VlanNetworkInterfaceService service;

    @Override
    public VlanNetworkInterfaceDto get() {
        Context context = getCurrentContext();
        try {
            return service.getVlanNetworkInterface(context);

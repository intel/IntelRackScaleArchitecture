...
public class BladeCollectionResource extends BaseResource {
    ...
    public CollectionDto get() {
        ...
        try {
            return service.getBladeCollection(context);
    ...
    @Path("{bladeId}")
    public BladeResource getBlade() {
        return getResource(BladeResource.class);
    }
}

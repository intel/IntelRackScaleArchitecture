...
/**
 * ComputeModule resource details provided by PSME.
 */
public interface PsmeComputeModule extends PsmeManagedResource {
    String getModel();
    ...
    Iterable<ResourceSupplier<PsmeBlade>> getBlades() throws RsaApiReaderException;

...
/**
 * FabricModule resource details provided by PSME.
 */
public interface PsmeFabricModule extends PsmeManagedResource  {
    State getState();
    Health getHealth();
    Location getLocation();

    Iterable<ResourceSupplier<PsmeSwitch>> getSwitches() throws RsaApiReaderException;
}

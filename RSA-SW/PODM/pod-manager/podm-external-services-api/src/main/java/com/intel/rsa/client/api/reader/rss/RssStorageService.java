...
public interface RssStorageService extends RssResource {
    ...
    Iterable<ResourceSupplier<RssDrive>> getDrives() throws RsaApiReaderException;
    Iterable<ResourceSupplier<RssLogicalDrive>> getLogicalDrives() throws RsaApiReaderException;
    Iterable<ResourceSupplier<RssRemoteTarget>> getRemoteTargets() throws RsaApiReaderException;

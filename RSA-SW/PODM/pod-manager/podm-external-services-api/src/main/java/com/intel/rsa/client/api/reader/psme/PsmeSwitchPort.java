...
public interface PsmeSwitchPort extends PsmeResource {
    Health getHealth();
    State getState();
    ...
    Integer getLinkSpeedGbps();
    String getNeighbourPort();
    Iterable<ResourceSupplier<PsmeVlanNetworkInterface>> getVlans() throws RsaApiReaderException;
}

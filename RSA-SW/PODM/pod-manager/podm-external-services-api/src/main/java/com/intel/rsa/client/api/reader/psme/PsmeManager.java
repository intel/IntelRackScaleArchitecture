...
/**
 * Manager resource details provided by PSME.
 */
public interface PsmeManager extends PsmeResource {
    String getModel();
    Health getHealth();
    State getState();
    ...
    ResourceSupplier<PsmeNetworkService> getNetworkService();
    Iterable<ResourceSupplier<PsmeNetworkInterface>> getNetworkInterfaces() throws RsaApiReaderException;
}

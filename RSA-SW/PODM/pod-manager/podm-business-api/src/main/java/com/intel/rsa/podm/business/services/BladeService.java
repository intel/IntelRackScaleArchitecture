...
public interface BladeService {
    ...
    /**
     * Returns collection of context elements which identify Blades available under specific Compute Module.
     ...
     */
    CollectionDto getBladeCollection(Context computeModuleContext) throws EntityNotFoundException;

    /**
     * Returns representation of a specific Blade.
     * @param bladeContext
     * @return
     * @throws EntityNotFoundException if Blade is not found in the context specified by the argument
     */
    BladeDto getBlade(Context bladeContext) throws EntityNotFoundException;
}

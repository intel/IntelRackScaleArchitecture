...
public interface SwitchService {
    CollectionDto getSwitchCollection(Context fabricModuleContext) throws EntityNotFoundException;
    SwitchDto getSwitch(Context switchContext) throws EntityNotFoundException;
}

...
public interface DrawerService {
    /**
     * Returns collection of context elements which identify Drawers available under specific Rack.
     * @param rackContext
     * @return
     * @throws EntityNotFoundException if Rack is not found in the context specified by the argument
     */
    CollectionDto getDrawerCollection(Context rackContext) throws EntityNotFoundException;
     ...
     */
    DrawerDto getDrawer(Context drawerContext) throws EntityNotFoundException;
}

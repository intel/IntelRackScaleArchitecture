...
public interface RemoteTargetService {
    ...
    /**
     * Returns collection of context elements which identify targets available under specific service.
     ...
     */
    CollectionDto getRemoteTargetCollection(Context serviceContext) throws EntityNotFoundException;

    /**
     * Returns representation of a specific Target.
     * @param targetContext
     * @return
     ...
     */
    RemoteTargetDto getRemoteTarget(Context targetContext) throws EntityNotFoundException;
}

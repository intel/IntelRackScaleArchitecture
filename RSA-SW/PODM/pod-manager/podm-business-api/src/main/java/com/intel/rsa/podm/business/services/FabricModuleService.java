...
public interface FabricModuleService {
    CollectionDto getFabricModuleCollection(Context drawerContext) throws EntityNotFoundException;
    FabricModuleDto getFabricModule(Context fabricModuleContext) throws EntityNotFoundException;
}

...
public final class ComputeModuleDto {
    private final Id id;
    ...
    private List<Context> containedBy;

    private ComputeModuleDto(Builder builder) {
        id = builder.id;
        name = builder.name;
        ...
        managedBy = Collections.unmodifiableList(builder.managedBy);
        containedBy = Collections.unmodifiableList(builder.containedBy);
    }
    ...
    public List<Context> getContainedBy() {
        return containedBy;
    }
    ...
    public static final class Builder {
        ...
        public Builder containedBy(List<Context> containedBy) {
            this.containedBy = containedBy;
            return this;
        }

        public ComputeModuleDto build() {
            return new ComputeModuleDto(this);
        }
    }
}

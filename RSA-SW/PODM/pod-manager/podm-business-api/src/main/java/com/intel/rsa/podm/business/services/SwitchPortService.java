...
public interface SwitchPortService {
    CollectionDto getSwitchPortCollection(Context switchContext) throws EntityNotFoundException;
    SwitchPortDto getSwitchPort(Context switchPortContext) throws EntityNotFoundException;
}

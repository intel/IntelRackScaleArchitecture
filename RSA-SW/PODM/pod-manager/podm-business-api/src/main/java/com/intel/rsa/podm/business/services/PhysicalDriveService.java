...
public interface PhysicalDriveService {
     ...
     */
    CollectionDto getPhysicalDriveCollection(Context serviceContext) throws EntityNotFoundException;
     ...
     */
    PhysicalDriveDto getPhysicalDrive(Context driveContext) throws EntityNotFoundException;
}

...
public:
     ...
     * @brief Add vlan.
     */
    virtual void add_vlan() = 0;

    /*!
     * @brief Remove vlan.
     */
    virtual void remove_vlan() = 0;
     ...
     */
    virtual void add_port(const PortIdentifier& port, bool tagged) = 0;

    /*!
     * @brief Remove port from vlan.
     * @param[in] port Port identifier.
     */
    virtual void remove_port(const PortIdentifier& port) = 0;
     ...
     */
    virtual void get_info(const PortIdentifier& port, VlanPortInfo& info) = 0;

...
public:
    ...
    void execute(const Request& request, Response& response) {
        ...
        if (uuid.empty()) {
            log_debug(GET_LOGGER("fm6000"), "Getting all componnets.");
            ...
            log_debug(GET_LOGGER("fm6000"), "Getting component with uuid=" << uuid);
            ...
            if (nullptr != module) {
                ...
                if (nullptr != submodule) {
                    ...
                    log_warning(GET_LOGGER("fm6000"), "Component uuid=" << uuid << "not found.");
        ...
        log_debug(GET_LOGGER("fm6000"), "Getting components is successfully finished.");
    }
...
static Command::Register<agent::network::hw::fm6000::GetComponents> g("fm6000");

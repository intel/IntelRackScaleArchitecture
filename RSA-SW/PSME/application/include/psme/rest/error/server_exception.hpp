 ...
 * */
#ifndef PSME_REST_ERROR_SERVEREEXCEPTION_HPP
#define	PSME_REST_ERROR_SERVEREEXCEPTION_HPP
...
public:
     ...
     * */
    const ServerError& get_error() const { return m_error; }
...
#endif	/* PSME_REST_ERROR_SERVEREEXCEPTION_HPP */

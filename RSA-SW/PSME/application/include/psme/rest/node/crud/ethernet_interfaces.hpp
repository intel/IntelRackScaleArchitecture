 ...
 *
 *
 * @file ethernet_interfaces.hpp
 *
 * @brief Declaration of EthernetInterface and EthernetInterfaces classes
 * */
#ifndef PSME_REST_NODE_NICS_HPP
#define PSME_REST_NODE_NICS_HPP
...
/*!
 * @brief Node representing EthernetInterface collection resource.
 * */
class EthernetInterfaces : public Node {
public:
    /*! @brief Type identifier */
    static constexpr const char TYPE[] = "EthernetInterfaces";
     ...
     */
    EthernetInterfaces(const string& uuid = "",
...
/*!
 * @brief Node representing EthernetInterface resource.
 * */
class EthernetInterface : public Node {
public:
    /*! @brief Type identifier */
    static constexpr const char TYPE[] = "EthernetInterface";
     ...
     * @param[in] id Node id in node's path.
     */
    EthernetInterface(const string& uuid = "",
                      const string& gami_id = "",
                      const string& id = "");

 ...
 * @file vlans.hpp
 *
 * @brief Declaration of Vlan and Vlans classes
 * */
#ifndef PSME_REST_NODE_VLANS_HPP
#define PSME_REST_NODE_VLANS_HPP
...
/*!
 * @brief Node representing VLAN collection resource.
 * */
class Vlans : public Node {
public:
    /*! @brief Type identifier */
    static constexpr const char TYPE[] = "VLANs";
...
/*!
 * @brief Node representing VLAN resource.
 * */
class Vlan : public Node {
public:
    /*! @brief Type identifier */
    static constexpr const char TYPE[] = "VLAN";
...
#endif /* PSME_REST_NODE_VLANS_HPP */

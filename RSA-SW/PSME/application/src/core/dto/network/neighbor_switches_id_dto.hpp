 ...
 * @section DESCRIPTION
 *
 * @file core/dto/network/neighbor_switches_id_dto.hpp
 * @brief Request transfer object declaration.
 * */

#ifndef PSME_CORE_DTO_NETWORK_NEIGHBOR_SWITCHES_ID_DTO_HPP
#define PSME_CORE_DTO_NETWORK_NEIGHBOR_SWITCHES_ID_DTO_HPP
...
/*! Neighbor Switches ID information DTO object */
class NeighborSwitchesIdDTO {
public:
    /*! Copy constructor */
    NeighborSwitchesIdDTO(const NeighborSwitchesIdDTO &) = default;

    /*! Assigment constructor */
    NeighborSwitchesIdDTO& operator=(const NeighborSwitchesIdDTO &) = default;

    /*! Default constructor */
    NeighborSwitchesIdDTO() {}
...
#endif /* PSME_CORE_DTO_NEIGHBOR_SWITCHES_ID_DTO_HPP */

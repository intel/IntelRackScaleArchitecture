...
#include "drive_info_dto.hpp"

using namespace psme::core::dto::compute;

DriveInfoDTO::~DriveInfoDTO(){}

DriveInfoDTO::Request::~Request(){}

DriveInfoDTO::Response::~Response(){}

const Json::Value DriveInfoDTO::Request::to_json() const {
...
void DriveInfoDTO::Response::to_object(const Json::Value& response) {

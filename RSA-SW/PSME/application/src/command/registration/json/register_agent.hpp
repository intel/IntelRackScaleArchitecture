...
#ifndef PSME_COMMAND_JSON_REGISTER_AGENT_HPP
#define PSME_COMMAND_JSON_REGISTER_AGENT_HPP
...
class RegisterAgent : public CommandJson {
public:
    /*!
...
#endif /* PSME_COMMAND_JSON_REGISTER_AGENT_HPP */

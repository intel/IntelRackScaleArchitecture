...
#ifndef PSME_COMMAND_REGISTRATION_REGISTER_AGENT_HPP
#define PSME_COMMAND_REGISTRATION_REGISTER_AGENT_HPP

#include "core/agent/capabilities.hpp"
#include "command/registration/tag.hpp"
...
using std::string;
using core::service::ComputeService;
...
public:
    ...
    public:
         ...
         */
        void set_gami_id(const string& gami_id) {
            m_gami_id = gami_id;
        }

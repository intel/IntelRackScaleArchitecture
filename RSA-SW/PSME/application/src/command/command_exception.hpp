...
#ifndef PSME_COMMAND_EXCEPTION_HPP
#define PSME_COMMAND_EXCEPTION_HPP
...
public:
    ...
    /*! Assignment operator */
    OverrideCommand& operator=(const OverrideCommand&) = default;
...
#endif /* PSME_COMMAND_EXCEPTION_HPP */

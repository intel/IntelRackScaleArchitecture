...
#ifndef AGENT_COMPUTE_IPMI_SET_SYSTEM_BOOT_OPTIONS_HPP
#define AGENT_COMPUTE_IPMI_SET_SYSTEM_BOOT_OPTIONS_HPP
...
public:
     ...
     */
    SetSystemBootOptions(const SetSystemBootOptions& orig);
...
#endif	/* AGENT_COMPUTE_IPMI_SET_SYSTEM_BOOT_OPTIONS_HPP */

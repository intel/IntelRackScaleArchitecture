...
request::GetDeviceId::GetDeviceId(): Request(NetFn::APP, Cmd::GET_DEVICE_ID) {}
...
response::GetDeviceId::GetDeviceId(): Response(NetFn::APP, Cmd::GET_DEVICE_ID, RESPONSE_SIZE) {}
response::GetDeviceId::~GetDeviceId() {}

const string& response::GetDeviceId::get_firmware_version() const {

 ...
 * */
#include "clear_boot_valid_bit.hpp"
...
request::ClearBootValidBit::ClearBootValidBit(const ClearBootValidBit& orig):
...
response::ClearBootValidBit::ClearBootValidBit(const ClearBootValidBit& orig):

 ...
 * @brief ...
 * */
#include "get_node_info.hpp"

using namespace agent::compute::ipmi;

request::GetNodeInfo::GetNodeInfo() : Request(NetFn::INTEL, Cmd::GET_NODE_INFO) {
}

request::GetNodeInfo::GetNodeInfo(const GetNodeInfo& orig) : Request(orig) {
}

request::GetNodeInfo::~GetNodeInfo() {
}

response::GetNodeInfo::GetNodeInfo() : Response(NetFn::INTEL, Cmd::GET_NODE_INFO, RESPONSE_SIZE) {
}

response::GetNodeInfo::GetNodeInfo(const GetNodeInfo& orig) : Response(orig) {
}

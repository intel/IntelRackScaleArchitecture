 ...
 * @section DESCRIPTION
 *
 * @file command/storage/get_logical_drive_info.cpp
 *
 * @brief Generic storage command GetLogicalDriveInfo implementation
 * */
...
constexpr const char GetLogicalDriveInfo::AGENT[];

constexpr const char GetLogicalDriveInfo::TAG[];

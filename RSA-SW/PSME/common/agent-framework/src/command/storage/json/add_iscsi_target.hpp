...
#ifndef AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_ADD_ISCSI_TARGET_HPP
#define AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_ADD_ISCSI_TARGET_HPP
...
class AddISCSITarget : public CommandJson {
public:
    /*! Agent tag string */
    static constexpr const char* AGENT = storage::AddISCSITarget::AGENT;

    /*! Command name tag string */
    static constexpr const char* TAG = storage::AddISCSITarget::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_ADD_ISCSI_TARGET_HPP */

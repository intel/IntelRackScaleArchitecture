...
#ifndef AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_DELETE_ISCSI_TARGET_HPP
#define AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_DELETE_ISCSI_TARGET_HPP
...
class DeleteISCSITarget : public CommandJson {
public:
    /*! Agent tag string */
    static constexpr const char* AGENT = storage::DeleteISCSITarget::AGENT;

    /*! Command name tag string */
    static constexpr const char* TAG = storage::DeleteISCSITarget::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_DELETE_ISCSI_TARGET_HPP */

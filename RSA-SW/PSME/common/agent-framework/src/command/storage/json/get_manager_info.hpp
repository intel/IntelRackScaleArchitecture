 ...
 * @section DESCRIPTION
 *
 * @file command/storage/json/get_manager_info.hpp
 *
 * @brief JSON command GetManagerInfo interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_MANAGER_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_MANAGER_INFO_HPP
...
class GetManagerInfo : public CommandJson {
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = storage::GetManagerInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = storage::GetManagerInfo::TAG;
...
#endif	/* AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_MANAGER_INFO_HPP */

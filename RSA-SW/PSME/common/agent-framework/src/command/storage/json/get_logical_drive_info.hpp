 ...
 * @section DESCRIPTION
 *
 * @file command/storage/json/get_logical_drive_info.hpp
 *
 * @brief JSON command GetLogicalDriveInfo
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_LOGICAL_DRIVE_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_LOGICAL_DRIVE_INFO_HPP
...
class GetLogicalDriveInfo : public CommandJson {
public:
    /*! Agent tag string */
    static constexpr const char* AGENT = storage::GetLogicalDriveInfo::AGENT;

    /*! Command name tag string */
    static constexpr const char* TAG = storage::GetLogicalDriveInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_JSON_STORAGE_GET_LOGICAL_DRIVE_INFO_HPP */

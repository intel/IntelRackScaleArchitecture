 ...
 * @section DESCRIPTION
 *
 * @file command/storage/json/delete_logical_drive.hpp
 *
 * @brief JSON command DeleteLogicalDrive
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_DELETE_LOGICAL_DRIVE_HPP
#define AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_DELETE_LOGICAL_DRIVE_HPP
...
class DeleteLogicalDrive : public CommandJson {
public:
    /*! Agent tag string */
    static constexpr const char* AGENT = storage::DeleteLogicalDrive::AGENT;

    /*! Command name tag string */
    static constexpr const char* TAG = storage::DeleteLogicalDrive::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_JSON_STORAGE_DELETE_LOGICAL_DRIVE_HPP */

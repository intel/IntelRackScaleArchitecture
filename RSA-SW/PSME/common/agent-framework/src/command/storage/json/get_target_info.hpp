...
#ifndef AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_TARGET_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_TARGET_INFO_HPP
...
class GetTargetInfo : public CommandJson {
public:
    /*! Agent tag string */
    static constexpr const char* AGENT = storage::GetTargetInfo::AGENT;

    /*! Command name tag string */
    static constexpr const char* TAG = storage::GetTargetInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_STORAGE_JSON_GET_TARGET_INFO_HPP */

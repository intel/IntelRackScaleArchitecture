 ...
 * @section DESCRIPTION
 *
 * @file command/network/json/get_manager_info.hpp
 *
 * @brief JSON command GetManagerInfo interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_MANAGER_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_MANAGER_INFO_HPP
...
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = network::GetManagerInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = network::GetManagerInfo::TAG;
...
#endif	/* AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_MANAGER_INFO_HPP */

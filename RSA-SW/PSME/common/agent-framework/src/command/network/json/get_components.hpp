 ...
 * @section DESCRIPTION
 *
 * @file command/network/json/get_components.hpp
 *
 * @brief JSON command get component info interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_COMPONENTS_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_COMPONENTS_HPP
...
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = network::GetComponents::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = network::GetComponents::TAG;
...
private:
    Json::Value m_add_component(
        network::GetComponents::Response::Component & component);

    Json::Value m_add_components(
        std::vector<network::GetComponents::Response::Component> & components);
...
#endif /* AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_COMPONENTS_HPP */

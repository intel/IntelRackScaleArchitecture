 ...
 * @section DESCRIPTION
 *
 * @file command/network/json/get_switch_info.hpp
 *
 * @brief JSON command get switch information interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_SWITCH_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_SWITCH_INFO_HPP
...
class GetSwitchInfo : public CommandJson {
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = network::GetSwitchInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = network::GetSwitchInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_NETWORK_JSON_GET_SWITCH_INFO_HPP */

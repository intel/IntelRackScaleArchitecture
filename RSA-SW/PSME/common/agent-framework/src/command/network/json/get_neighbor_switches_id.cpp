 ...
 *
 * @file command/network/json/get_neighbor_switches_id.cpp
 * @brief JSON command get neighbor switches id information implementation
 * */

#include "get_neighbor_switches_id.hpp"
...
void GetNeighborSwitchesId::method(const Json::Value& params, Json::Value& result) {
    try {
        Command* command = get_command();

        network::GetNeighborSwitchesId::Request request{};
        network::GetNeighborSwitchesId::Response response{};
...
void GetNeighborSwitchesId::notification(const Json::Value&) { }

static CommandJson::Register<GetNeighborSwitchesId> g;

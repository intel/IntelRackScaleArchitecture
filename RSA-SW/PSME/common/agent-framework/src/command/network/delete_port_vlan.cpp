 ...
 * @section DESCRIPTION
 *
 * @file command/network/delete_port_vlan.cpp
 *
 * @brief Generic network command DeletePortVlan implementation
 * */
...
constexpr const char DeletePortVlan::AGENT[];

constexpr const char DeletePortVlan::TAG[];

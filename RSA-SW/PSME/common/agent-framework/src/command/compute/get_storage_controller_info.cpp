...
using agent_framework::command::compute::GetStorageControllerInfo;

constexpr const char GetStorageControllerInfo::AGENT[];
constexpr const char GetStorageControllerInfo::TAG[];

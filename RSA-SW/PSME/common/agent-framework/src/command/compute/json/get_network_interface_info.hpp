 ...
 * @section DESCRIPTION
 *
 * @file command/compute/json/get_network_interface_info.hpp
 *
 * @brief JSON command get processor information interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_NETWORK_INTERFACE_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_NETWORK_INTERFACE_INFO_HPP
...
class GetNetworkInterfaceInfo : public CommandJson {
public:
    /*! Agent tag string */
    static constexpr const char* AGENT = compute::GetNetworkInterfaceInfo::AGENT;

    /*! Command name tag string */
    static constexpr const char* TAG = compute::GetNetworkInterfaceInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_NETWORK_INTERFACE_INFO_HPP */

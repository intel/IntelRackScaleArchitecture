 ...
 * @section DESCRIPTION
 *
 * @file command/compute/json/get_module_info.hpp
 *
 * @brief JSON command get module info interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MODULE_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MODULE_INFO_HPP
...
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = compute::GetModuleInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = compute::GetModuleInfo::TAG;
...
#endif	/* AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MODULE_INFO_HPP */

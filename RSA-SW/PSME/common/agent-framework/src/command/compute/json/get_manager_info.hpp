 ...
 * @section DESCRIPTION
 *
 * @file command/compute/json/get_manager_info.hpp
 *
 * @brief JSON command get component info interface
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MANAGER_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MANAGER_INFO_HPP
...
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = compute::GetManagerInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = compute::GetManagerInfo::TAG;
...
#endif	/* AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MANAGER_INFOHPP */

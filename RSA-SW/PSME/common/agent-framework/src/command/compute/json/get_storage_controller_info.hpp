...
#ifndef AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_STORAGE_CONTROLLER_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_STORAGE_CONTROLLER_INFO_HPP
...
/*! JSON getStorageControllerInfo class */
class GetStorageControllerInfo : public CommandJson {
public:
    /*! Agent tag string */
    static constexpr const char* AGENT = compute::GetStorageControllerInfo::AGENT;

    /*! Command name tag string */
    static constexpr const char* TAG = compute::GetStorageControllerInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_STORAGE_CONTROLLER_INFO_HPP */

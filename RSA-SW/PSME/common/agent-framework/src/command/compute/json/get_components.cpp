 ...
 * @section DESCRIPTION
 *
 * @file command/compute/json/get_component_info.cpp
 *
...
void GetComponents::method(const Json::Value& params, Json::Value& result) {
    try {
        ...
        compute::GetComponents::Request request{};
        compute::GetComponents::Response response{};
...
Json::Value GetComponents::m_add_component(compute::GetComponents::Response::Component & component) {
    Json::Value item;
...
Json::Value GetComponents::m_add_components(std::vector<compute::GetComponents::Response::Component> & components) {
    Json::Value json_components;
    Json::Value json_item;
    for (compute::GetComponents::Response::Component component : components) {

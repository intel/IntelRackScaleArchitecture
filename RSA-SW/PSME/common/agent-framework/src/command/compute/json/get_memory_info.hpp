...
#ifndef AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MEMORY_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MEMORY_INFO_HPP
...
class GetMemoryInfo : public CommandJson {
public:
    /*! Agent name tag */
    static constexpr const char* AGENT = compute::GetMemoryInfo::AGENT;

    /*! Command name tag */
    static constexpr const char* TAG = compute::GetMemoryInfo::TAG;
...
#endif /* AGENT_FRAMEWORK_COMMAND_COMPUTE_JSON_GET_MEMORY_INFO_HPP */

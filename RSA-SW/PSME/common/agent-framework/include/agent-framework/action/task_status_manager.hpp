 ...
 *
 * @brief Task status manager interface
 * */
...
/*! TaskStatusManager represents status of task */
...
public:
    ...
    /*! Singleton pattern. Clear global TaskStatusManager object */
    static void cleanup();
...
private:
    ...
    /*! Init global task runner object */
    static void init();

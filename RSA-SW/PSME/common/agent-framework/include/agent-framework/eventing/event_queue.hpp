 ...
 *
 * @brief Eventing Queue
 * */


#ifndef AGENT_FRAMEWORK_EVENTING_EVENT_QUEUE_HPP
#define AGENT_FRAMEWORK_EVENTING_EVENT_QUEUE_HPP
...
#endif /* AGENT_FRAMEWORK_EVENTING_EVENT_QUEUE_HPP */

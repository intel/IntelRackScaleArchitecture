 ...
 *
 * @brief Invalid Parameters interface
 * */
...
/*! Invalid parameters exception class */
class InvalidParameters final : public ExceptionBase {
public:
    explicit InvalidParameters(const std::string& msg) :
             ExceptionBase{ErrorCode::InvalidParameter, msg} {}

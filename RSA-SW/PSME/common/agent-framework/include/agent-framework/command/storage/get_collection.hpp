 ...
 *
 *
 * @file command/storage/get_collection.hpp
 * @brief Generic storage GetCollection command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_STORAGE_GET_COLLECTION_HPP
#define AGENT_FRAMEWORK_COMMAND_STORAGE_GET_COLLECTION_HPP
...
/*! Generic storage command GetCollection */
...
#endif /* AGENT_FRAMEWORK_COMMAND_STORAGE_GET_COLLECTION_HPP */

...
#ifndef AGENT_FRAMEWORK_COMMAND_COMMAND_JSON_SERVER_HPP
#define AGENT_FRAMEWORK_COMMAND_COMMAND_JSON_SERVER_HPP
...
#endif /* AGENT_FRAMEWORK_COMMAND_COMMAND_JSON_SERVER_HPP */

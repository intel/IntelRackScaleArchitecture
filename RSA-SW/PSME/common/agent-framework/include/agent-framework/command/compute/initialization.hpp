 ...
 *
 *
 * @file command/compute/initialization.hpp
 * @brief Initialization command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_COMPUTE_INITIALIZATION_HPP
#define AGENT_FRAMEWORK_COMMAND_COMPUTE_INITIALIZATION_HPP
...
#endif /* AGENT_FRAMEWORK_COMMAND_COMPUTE_INITIALIZATION_HPP */

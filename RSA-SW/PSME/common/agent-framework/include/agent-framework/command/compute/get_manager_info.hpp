 ...
 *
 *
 * @file command/compute/get_manager_info.hpp
 * @brief Generic compute GetManagerInfo command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_COMPUTE_GET_MANAGER_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_COMPUTE_GET_MANAGER_INFO_HPP
...
/*! Generic compute command GetManagerInfo */
...
#endif	/* AGENT_FRAMEWORK_COMMAND_COMPUTE_GET_MANAGER_INFO_HPP */

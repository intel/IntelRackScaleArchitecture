 ...
 *
 *
 * @file command/compute/get_module_info.hpp
 * @brief Generic compute GetModuleInfo command
 * */

#ifndef AGENT_FRAMEWORK_COMMAND_COMPUTE_GET_MODULE_INFO_HPP
#define AGENT_FRAMEWORK_COMMAND_COMPUTE_GET_MODULE_INFO_HPP
...
/*! Generic compute command GetModuleInfo */
...
#endif	/* AGENT_FRAMEWORK_COMMAND_COMPUTE_GET_MODULE_INFO_HPP */

...
/*! Module class */
class Module {
    const std::string COMPUTE_MODULE_TYPE = "RSAComputeModule";

    StateMachineUniquePtr m_state_machine = nullptr;
    ModuleSoftwareStatus *m_sw_status = nullptr;
    ModuleHardwareStatus *m_hw_status = nullptr;
...
public:
    ...
    Module(const std::string ip_address = "1.1.2.1") {
        ...
        m_sw_status = new ModuleSoftwareStatus(ip_address);
        m_hw_status = new ModuleHardwareStatus(ip_address);
    ...
    /*! Initializes all components of Module. */
    void init();

    /*! Deinitializes all components of Module. */
    void clean();
    ...
    /*!
     *  @brief Get curret state.
     *  @return State Machine
     * */
    const StateMachineUniquePtr& get_state_machine() const {
        return m_state_machine;
    }

    /*!
     * @brief  Get current software status.
     * @return Module software status.
     * */
    ModuleSoftwareStatus * get_sw_status() const {
        return m_sw_status;
    }
     ...
     * */
    ModuleHardwareStatus * get_hw_status() const {
        return m_hw_status;
    }
     ...
     * */
    ModuleState::State get_state() const;

    /*!
     * @brief Get module state.
     * @return String representation of module state.
     * */

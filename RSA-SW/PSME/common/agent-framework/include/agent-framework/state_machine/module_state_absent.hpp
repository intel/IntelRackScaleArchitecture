 ...
 * @brief %StateMachine ABSENT state.
 */
class ModuleStateAbsent : public ModuleState {
public:
    /*!
     * @brief Class default constructor.
     */
    ModuleStateAbsent() : ModuleState(State::ABSENT) {}
     ...
     */
    StateMachineTransitionUniquePtr enter_state(StateMachineTransitionUniquePtr transition,

...
public:
     ...
     */
    virtual bool is_valid(const json::Value& value) override;
     ...
     * @return Value
     */
    T get_value(const json::Value& value);
...
template <typename T>
bool AnyOfValidator<T>::is_valid(const json::Value& value) {
    if (!check_type(value)) {
        return false;
    }
...
template<>
int AnyOfValidator<int>::get_value(const json::Value& value) {
    return value.as_int();
}

template<>
double AnyOfValidator<double>::get_value(const json::Value& value) {
    return value.as_double();
}

template<>
std::string AnyOfValidator<std::string>::get_value(const json::Value& value) {
